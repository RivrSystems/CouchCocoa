...
@protocol CouchAuthorizer <NSObject>
...
/** Simple implementation of CouchAuthorizer that does HTTP Basic Auth. */
@interface CouchBasicAuthorizer : NSObject <CouchAuthorizer>
{
@private
...
@interface CouchMACAuthorizer : NSObject <CouchAuthorizer>
{
@private
