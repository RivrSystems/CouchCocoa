...
+ (NSData *)dataWithJSONObject:(id)object
                       options:(NSJSONWritingOptions)options
                         error:(NSError **)error
{
    if ((options & CouchJSONWritingAllowFragments)
        ...
        NSData* json = [super dataWithJSONObject: object
                                         options: (options & ~CouchJSONWritingAllowFragments)
                                           error: NULL];
...
@implementation CouchLazyArrayOfJSON
...
- (id)objectAtIndex:(NSUInteger)index {
    ...
    if ([obj isKindOfClass: [NSData class]]) {
        obj = [CouchJSON JSONObjectWithData: obj options: CouchJSONReadingAllowFragments
                                   error: nil];
